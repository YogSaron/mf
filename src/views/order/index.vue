<template>
  <div class="app-container table-layout">
    <div class="left-table">
      <el-button class="pan-btn blue-btn" style="width:100%;margin-bottom:10px;" @click="loadingAllList">全部订单</el-button>
      <customer-list :list="customerList" @add="handleChoose"></customer-list>
    </div>
    <div class="right-table">
      <div class="filter-container">
        <el-button class="pan-btn tiffany-btn" @click="add">新建订单</el-button>
...
export default {
  ...
  methods: {
    ...
    handleCheck(id) {
      this.$router.push({ name: 'board', query: { pageId: id }})
    },
    handleDelete(id) {
